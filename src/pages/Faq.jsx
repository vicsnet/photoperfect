                ...
                >
                  <div className="w-[90%] mx-auto ">
                    <div className="flex justify-between pt-[15px] pb-[15px]">
                      <p
                        className="flex  text-[16px] items-center md:text-[22px] font-medium shadow-lg"
                        style={{ color: "rgba(51, 51, 51, 1)" }}
                      >
                       {title}
                      </p>
                      ...
                      <span>
                        {!open ? (
                          <img
                            src={openIcon}
                            alt=""
                            className="flex items-center w-[60px] md:w-[40px] "
                            onClick={handleClick}
                          />
                        ) : (
                          <img
                            src={closeIcon}
                            alt=""
                            className="flex items-center justify-center mx-auto w-[40px]"
                            onClick={handleClick}
                          />
                        )}
                      </span>
